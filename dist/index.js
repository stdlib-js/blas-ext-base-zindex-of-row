...
var I=require('@stdlib/blas-base-assert-is-layout/dist'),J=require('@stdlib/ndarray-base-assert-is-row-major-string/dist'),K=require('@stdlib/ndarray-base-assert-is-column-major-string/dist'),F=require('@stdlib/strided-base-stride2offset/dist'),P=require('@stdlib/math-base-special-fast-max/dist'),S=require('@stdlib/error-tools-fmtprodmsg/dist'),Q=O();function U(e,a,s,f,i,w,g,R,l){var m,x,o;if(!I(e))throw new TypeError(S('2ivFx',e));if(J(e)?o=s:o=a,i<P(1,o))throw new RangeError(S('2ivIR',o,i));return K(e)?(m=1,x=i):(m=i,x=1),Q(a,s,f,m,x,0,w,g,F(s,g),R,l,F(a,l))}V.exports=U
